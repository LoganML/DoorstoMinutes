(function (factory) {
    ...
    var AuthInfo_1 = require("./auth/internal/AuthInfo");
    exports.AuthInfo = AuthInfo_1.default;
    var CoreStitchAuth_1 = require("./auth/internal/CoreStitchAuth");
    exports.CoreStitchAuth = CoreStitchAuth_1.default;
    var CoreStitchUserImpl_1 = require("./auth/internal/CoreStitchUserImpl");
    exports.CoreStitchUserImpl = CoreStitchUserImpl_1.default;
    var DeviceFields_1 = require("./auth/internal/DeviceFields");
    exports.DeviceFields = DeviceFields_1.default;
    var ApiStitchUserIdentity_1 = require("./auth/internal/models/ApiStitchUserIdentity");
    exports.ApiStitchUserIdentity = ApiStitchUserIdentity_1.default;
    var StitchUserProfileImpl_1 = require("./auth/internal/StitchUserProfileImpl");
    exports.StitchUserProfileImpl = StitchUserProfileImpl_1.default;
    var AnonymousAuthProvider_1 = require("./auth/providers/anonymous/AnonymousAuthProvider");
    exports.AnonymousAuthProvider = AnonymousAuthProvider_1.default;
    var AnonymousCredential_1 = require("./auth/providers/anonymous/AnonymousCredential");
    exports.AnonymousCredential = AnonymousCredential_1.default;
    var CustomAuthProvider_1 = require("./auth/providers/custom/CustomAuthProvider");
    exports.CustomAuthProvider = CustomAuthProvider_1.default;
    var CustomCredential_1 = require("./auth/providers/custom/CustomCredential");
    exports.CustomCredential = CustomCredential_1.default;
    var FacebookAuthProvider_1 = require("./auth/providers/facebook/FacebookAuthProvider");
    exports.FacebookAuthProvider = FacebookAuthProvider_1.default;
    var FacebookCredential_1 = require("./auth/providers/facebook/FacebookCredential");
    exports.FacebookCredential = FacebookCredential_1.default;
    var GoogleAuthProvider_1 = require("./auth/providers/google/GoogleAuthProvider");
    exports.GoogleAuthProvider = GoogleAuthProvider_1.default;
    var GoogleCredential_1 = require("./auth/providers/google/GoogleCredential");
    exports.GoogleCredential = GoogleCredential_1.default;
    var StitchAuthResponseCredential_1 = require("./auth/providers/internal/StitchAuthResponseCredential");
    exports.StitchAuthCredential = StitchAuthResponseCredential_1.default;
    var StitchAuthResponseCredential_2 = require("./auth/providers/internal/StitchAuthResponseCredential");
    exports.StitchAuthResponseCredential = StitchAuthResponseCredential_2.default;
    var ServerApiKeyAuthProvider_1 = require("./auth/providers/serverapikey/ServerApiKeyAuthProvider");
    exports.ServerApiKeyAuthProvider = ServerApiKeyAuthProvider_1.default;
    var ServerApiKeyCredential_1 = require("./auth/providers/serverapikey/ServerApiKeyCredential");
    exports.ServerApiKeyCredential = ServerApiKeyCredential_1.default;
    var CoreUserApiKeyAuthProviderClient_1 = require("./auth/providers/userapikey/CoreUserApiKeyAuthProviderClient");
    exports.CoreUserApiKeyAuthProviderClient = CoreUserApiKeyAuthProviderClient_1.default;
    var UserApiKey_1 = require("./auth/providers/userapikey/models/UserApiKey");
    exports.UserApiKey = UserApiKey_1.default;
    var UserApiKeyAuthProvider_1 = require("./auth/providers/userapikey/UserApiKeyAuthProvider");
    exports.UserApiKeyAuthProvider = UserApiKeyAuthProvider_1.default;
    var UserApiKeyCredential_1 = require("./auth/providers/userapikey/UserApiKeyCredential");
    exports.UserApiKeyCredential = UserApiKeyCredential_1.default;
    var CoreUserPasswordAuthProviderClient_1 = require("./auth/providers/userpass/CoreUserPasswordAuthProviderClient");
    exports.CoreUserPassAuthProviderClient = CoreUserPasswordAuthProviderClient_1.default;
    var UserPasswordAuthProvider_1 = require("./auth/providers/userpass/UserPasswordAuthProvider");
    exports.UserPasswordAuthProvider = UserPasswordAuthProvider_1.default;
    var UserPasswordCredential_1 = require("./auth/providers/userpass/UserPasswordCredential");
    exports.UserPasswordCredential = UserPasswordCredential_1.default;
    var StitchUserIdentity_1 = require("./auth/StitchUserIdentity");
    exports.StitchUserIdentity = StitchUserIdentity_1.default;
    var UserType_1 = require("./auth/UserType");
    ...
    var CoreStitchAppClient_1 = require("./internal/CoreStitchAppClient");
    exports.CoreStitchAppClient = CoreStitchAppClient_1.default;
    var FetchTransport_1 = require("./internal/net/FetchTransport");
    exports.FetchTransport = FetchTransport_1.default;
    var Method_1 = require("./internal/net/Method");
    exports.Method = Method_1.default;
    var Response_1 = require("./internal/net/Response");
    exports.Response = Response_1.default;
    var StitchAppAuthRoutes_1 = require("./internal/net/StitchAppAuthRoutes");
    exports.StitchAppAuthRoutes = StitchAppAuthRoutes_1.default;
    var StitchAppRoutes_1 = require("./internal/net/StitchAppRoutes");
    ...
    var StitchRequestClient_1 = require("./internal/net/StitchRequestClient");
    exports.StitchRequestClient = StitchRequestClient_1.default;
    var CoreStitchServiceClientImpl_1 = require("./services/internal/CoreStitchServiceClientImpl");
    exports.CoreStitchServiceClientImpl = CoreStitchServiceClientImpl_1.default;
    var StitchServiceRoutes_1 = require("./services/internal/StitchServiceRoutes");
    ...
    var StitchAppClientInfo_1 = require("./StitchAppClientInfo");
    exports.StitchAppClientInfo = StitchAppClientInfo_1.default;
    var StitchClientError_1 = require("./StitchClientError");
    ...
    var StitchError_1 = require("./StitchError");
    exports.StitchError = StitchError_1.default;
    var StitchRequestError_1 = require("./StitchRequestError");
    ...
    var StitchServiceError_1 = require("./StitchServiceError");
