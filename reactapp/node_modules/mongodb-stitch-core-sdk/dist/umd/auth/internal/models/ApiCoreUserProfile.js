...
(function (factory) {
    ...
    var Assertions_1 = require("../../../internal/common/Assertions");
    var StitchUserProfileImpl_1 = require("../StitchUserProfileImpl");
    var ApiStitchUserIdentity_1 = require("./ApiStitchUserIdentity");
    var Fields;
    (function (Fields) {
        Fields["DATA"] = "data";
